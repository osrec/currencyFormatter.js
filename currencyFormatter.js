...
OSREC.CurrencyFormatter =
{
	...
	locales:
	{
		...
		ar_KM: { h: 'ar' },
		ar_KW: { h: 'ar' },
		ar_LB: { p: '! #,##0.00', g: '.', d: ',', c: 'LBP' },
		ar_LY: { p: '! #,##0.00', g: '.', d: ',', c: 'LYD' },
		ar_MA: { p: '! #,##0.00', g: '.', d: ',', c: 'CS' },
		ar_MR: { p: '! #,##0.00', g: '.', d: ',', c: 'MRO' },
		ar_OM: { h: 'ar' },
		ar_PS: { h: 'ar' },
		ar_QA: { h: 'ar' },
		ar_SA: { h: 'ar' },
		...
		dav_KE: { h: 'dav' },
		de: { p: '#,##0.00 !', g: '.', d: ',', c: 'CHF' },
		de_AT: { p: '! #,##0.00', g: ' ', d: ',', c: 'CS' },
		de_BE: { h: 'de' },
		de_CH: { p: '! #,##0.00;!-#,##0.00', g: '\'', d: '.', c: 'CHF' },
		de_DE: { h: 'de' },
		de_LI: { p: '! #,##0.00', g: '\'', d: '.', c: 'CS' },
		de_LU: { h: 'de' },
		dje: { p: '#,##0.00!', g: ' ', d: '.', c: 'CS' },
		dje_NE: { h: 'dje' },
		dsb: { p: '#,##0.00 !', g: '.', d: ',', c: 'CS' },
		...
		en: { p: '!#,##0.00', g: ',', d: '.', c: 'AUD' },
		en_001: { h: 'en' },
		en_150: { p: '#,##0.00 !', g: '.', d: ',', c: 'CS' },
		en_AG: { h: 'en' },
		en_AI: { h: 'en' },
		en_AS: { h: 'en' },
		en_AT: { p: '! #,##0.00', g: ',', d: '.', c: 'CS' },
		en_AU: { h: 'en' },
		en_BB: { h: 'en' },
		en_BE: { p: '#,##0.00 !', g: '.', d: ',', c: 'CS' },
		en_BI: { h: 'en' },
		en_BM: { h: 'en' },
		en_BS: { h: 'en' },
		en_BW: { h: 'en' },
		...
		en_UM: { h: 'en' },
		en_US: { h: 'en' },
		en_US_POSIX: { p: '! #0.00', g: ',', d: '.', c: 'CS' },
		en_VC: { h: 'en' },
		en_VG: { h: 'en' },
		en_VI: { h: 'en' },
		en_VU: { h: 'en' },
		en_WS: { h: 'en' },
		en_ZA: { p: '!#,##0.00', g: ' ', d: ',', c: 'CS' },
		en_ZM: { h: 'en' },
		en_ZW: { h: 'en' },
		eo: { p: '!#,##0.00', g: ' ', d: ',', c: 'CS' },
		eo_001: { h: 'eo' },
		es: { p: '#,##0.00 !', g: '.', d: ',', c: 'ARS' },
		es_419: { p: '!#,##0.00', g: ',', d: '.', c: 'CS' },
		es_AR: { p: '! #,##0.00', g: '.', d: ',', c: 'ARS' },
		es_BO: { h: 'es' },
		es_BR: { h: 'es' },
		es_CL: { p: '!#,##0.00;!-#,##0.00', g: '.', d: ',', c: 'CLP' },
		es_CO: { p: '! #,##0.00', g: '.', d: ',', c: 'COP' },
		es_CR: { p: '#,##0.00 !', g: ' ', d: ',', c: 'CRC' },
		es_CU: { h: 'es' },
		es_DO: { h: 'es' },
		es_EA: { h: 'es' },
		es_EC: { p: '!#,##0.00;!-#,##0.00', g: '.', d: ',', c: 'CS' },
		es_ES: { h: 'es' },
		es_GQ: { p: '!#,##0.00', g: '.', d: ',', c: 'CS' },
		es_GT: { h: 'es' },
		es_HN: { h: 'es' },
		es_IC: { h: 'es' },
		es_MX: { h: 'es' },
		...
		es_PH: { h: 'es' },
		es_PR: { h: 'es' },
		es_PY: { p: '! #,##0.00;! -#,##0.00', g: '.', d: ',', c: 'PYG' },
		es_SV: { h: 'es' },
		es_US: { h: 'es' },
		es_UY: { p: '! #,##0.00', g: '.', d: ',', c: 'UYU' },
		es_VE: { p: '!#,##0.00;!-#,##0.00', g: '.', d: ',', c: 'VEF' },
		et: { p: '#,##0.00 !', g: ' ', d: ',', c: 'CS' },
		et_EE: { h: 'et' },
		eu: { p: '#,##0.00 !', g: '.', d: ',', c: 'CS' },
		eu_ES: { h: 'eu' },
		...
		fi_FI: { h: 'fi' },
		fil: { p: '!#,##0.00', g: ',', d: '.', c: 'PHP' },
		fil_PH: { h: 'fil' },
		fo: { p: '#,##0.00 !', g: '.', d: ',', c: 'CS' },
		fo_DK: { h: 'fo' },
		fo_FO: { h: 'fo' },
		fr: { p: '#,##0.00 !', g: ' ', d: ',', c: 'BIF' },
		fr_BE: { p: '#,##0.00 !', g: '.', d: ',', c: 'CS' },
		fr_BF: { h: 'fr' },
		fr_BI: { h: 'fr' },
		fr_BJ: { h: 'fr' },
		fr_BL: { h: 'fr' },
		...
		fr_HT: { h: 'fr' },
		fr_KM: { h: 'fr' },
		fr_LU: { p: '#,##0.00 !', g: '.', d: ',', c: 'CS' },
		fr_MA: { p: '#,##0.00 !', g: '.', d: ',', c: 'CS' },
		fr_MC: { h: 'fr' },
		fr_MF: { h: 'fr' },
		fr_MG: { h: 'fr' },
		fr_ML: { h: 'fr' },
		...
		ne_IN: { h: 'ne' },
		ne_NP: { h: 'ne' },
		nl: { p: '! #,##0.00;! -#,##0.00', g: '.', d: ',', c: 'ANG' },
		nl_AW: { h: 'nl' },
		nl_BE: { p: '#,##0.00 !', g: '.', d: ',', c: 'CS' },
		nl_BQ: { h: 'nl' },
		nl_CW: { h: 'nl' },
		nl_NL: { h: 'nl' },
		nl_SR: { h: 'nl' },
		...
		pt_MO: { h: 'pt' },
		pt_MZ: { h: 'pt' },
		pt_PT: { p: '#,##0.00 !', g: ' ', d: ',', c: 'CS' },
		pt_ST: { h: 'pt' },
		pt_TL: { h: 'pt' },
		qu: { p: '! #,##0.00', g: ',', d: '.', c: 'CS' },
		qu_BO: { p: '! #,##0.00', g: '.', d: ',', c: 'CS' },
		qu_EC: { h: 'qu' },
		qu_PE: { h: 'qu' },
		rm: { p: '#,##0.00 !', g: '’', d: '.', c: 'CS' },
		rm_CH: { h: 'rm' },
		...
		ta_IN: { h: 'ta' },
		ta_LK: { h: 'ta' },
		ta_MY: { p: '! #,##0.00', g: ',', d: '.', c: 'CS' },
		ta_SG: { p: '! #,##0.00', g: ',', d: '.', c: 'CS' },
		te: { p: '!#,##,##0.00', g: ',', d: '.', c: 'CS' },
		te_IN: { h: 'te' },
		teo: { p: '!#,##0.00', g: ',', d: '.', c: 'CS' },
		teo_KE: { h: 'teo' },
		...
		ur_PK: { h: 'ur' },
		uz: { p: '#,##0.00 !', g: ' ', d: ',', c: 'UZS' },
		uz_Arab: { p: '#,##0.00 !', g: '.', d: ',', c: 'CS' },
		uz_Arab_AF: { h: 'uz' },
		uz_Cyrl: { p: '! #,##0.00', g: ' ', d: ',', c: 'CS' },
		uz_Cyrl_UZ: { h: 'uz' },
		uz_Latn: { h: 'uz' },
		uz_Latn_UZ: { h: 'uz' },
		vai: { p: '!#,##0.00', g: ',', d: '.', c: 'CS' },
